...
// A self-contained component to handle the word animation, based on your reference.
const AnimatedWord = ({
  children,
  variants,
}: {
...
// --- END: Added for Animated Headline ---
    ...
    <>
      ...
      <section className={styles.typography}>
        ...
        <Image
          ...
          height={150}
        />
        {/* <Image className={styles.green} src="/static/evense/evense-green.svg" alt="Decorative green shape" width={150} height={150} /> */}
      </section>
